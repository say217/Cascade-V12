...
model_path = r".model\Landslide_segment_model.pt"
video_path = r"Assets\test_vedio\Landslide.mp4"
...
WIN_DET = "Landslide Detection - Bounding Boxes"
WIN_SEG = "Landslide Detection - Boxes + Segmentation"
...
def predict_tiles(frame):
    ...
    localized landslide pockets instead of one massive box over the entire screen.
    """
